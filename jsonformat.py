...
from zhipupower import openai_api_key
...
def analyze_project_profile(project_dir, message_placeholder, name):
    ...
    prompts = "这是一个已经完成的软件项目，接下来我会给你项目的readme.md文件, 请你对项目进行分析说明，并书写一份项目介绍，介绍项目的相关技术栈，优点。\n\n"
    
    for file_name, file_path, code_content in code_files:
        prompt = f"""这是说明文件的名字 {file_name} ，说明文件的路径是 {file_path}。：\n\n<details>{code_content}\n\n</details> 。\n\n"""
        prompts +=(prompt)

    prompts +="请给我一份详细的说明报告，介绍项目的相关技术栈，优点，以及项目的设计思路。"
